...
public class WechatPayOptions
{
    ...
    /// <para>配置后 H5 下单自动拼接，也可在 <see cref="GaoXinLibrary.PaySDK.Wechat.Models.WechatH5OrderRequest.RedirectUrl"/> 中按请求覆盖。</para>
    /// </summary>
    ...
    /// <para>微信支付没有公开沙箱环境，开发测试可使用商户平台的测试商户号进行联调。</para>
    /// </summary>
