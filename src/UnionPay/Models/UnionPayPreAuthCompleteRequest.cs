...
/// </summary>
public class UnionPayPreAuthCompleteRequest
{
    /// <summary>交易类型，固定 03（预授权完成）</summary>
    public string TxnType { get; set; } = "03";

    /// <summary>交易子类，固定 00</summary>
    public string TxnSubType { get; set; } = "00";

    /// <summary>产品类型，与原始预授权交易保持一致</summary>
    ...
    /// <summary>交易金额（分），可小于等于原预授权金额</summary>
