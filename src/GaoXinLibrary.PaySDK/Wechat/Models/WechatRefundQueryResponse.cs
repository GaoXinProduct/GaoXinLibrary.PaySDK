...
/// </summary>
public class WechatRefundQueryResponse : WechatPayBaseResponse
{
    ...
    /// <summary>
    /// 资金账户：UNSETTLED / AVAILABLE / UNAVAILABLE / OPERATION / BASIC / ECNY_BASIC
    /// </summary>
    [JsonPropertyName("funds_account")]
    public string? FundsAccount { get; set; }

    /// <summary>金额详情</summary>
    [JsonPropertyName("amount")]
    public WechatRefundQueryAmount? Amount { get; set; }

    /// <summary>优惠退款信息</summary>
