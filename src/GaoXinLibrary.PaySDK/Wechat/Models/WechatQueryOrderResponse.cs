...
/// </summary>
public class WechatQueryOrderResponse : WechatPayBaseResponse
{
    ...
    /// <summary>交易类型：JSAPI / NATIVE / APP / MICROPAY / MWEB / FACEPAY</summary>
    ...
    /// <summary>支付完成时间，遵循 rfc3339 标准</summary>
