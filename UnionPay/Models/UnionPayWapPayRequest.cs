...
/// <summary>
/// 银联 WAP 支付（手机网页支付）请求参数
/// <para>https://open.unionpay.com/tjweb/api/dictionary?index=1&amp;catId=10&amp;apiSvcId=453</para>
/// </summary>
public class UnionPayWapPayRequest
{
    ...
    /// <summary>产品类型，000201 = B2C 网关支付</summary>
    public string BizType { get; set; } = "000201";

    /// <summary>渠道类型，08 = 手机</summary>
