...
/// </summary>
public class UnionPayPreAuthRequest
{
    /// <summary>交易类型，固定 02（预授权）</summary>
    public string TxnType { get; set; } = "02";

    /// <summary>交易子类，固定 01（自助消费）</summary>
    public string TxnSubType { get; set; } = "01";

    /// <summary>产品类型，000301 = 无跳转支付</summary>
